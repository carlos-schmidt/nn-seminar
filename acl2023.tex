...
% TODO checklist
% • 5 pages, two-columned
% • not less; images should be used economically;
% references do not count;
% downgrading if more than 5.5 pages;
% appendix allowed but everything important should be in the main part
...
%\subsection{History of Speech Representation Learning}Probably remove, only keep if too few pages... Show first approaches (?) 
%\subsection{Self-Supervised Learning for Speech Representation Models}\input{chapters/self-supervised-learning}
